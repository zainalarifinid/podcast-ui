...
import Vue from "vue";
import { PROFILE_FOLLOW, PROFILE_UNFOLLOW, PROFILE_SEARCH, FETCH_PROFILE_USER, PROFILE_SEARCH_RESET_STATE, FETCH_PROFILE_RESET, FETCH_LIST_FOLLOWER, FETCH_LIST_FOLLOWING, CHECK_FOLLOWING} from "./actionTypes";
import ApiService from "../../common/apiService";
import { SET_PROFILE, FETCH_PROFILE, RESET_SEARCH_PROFILE, RESET_PROFILE, SET_LIST_FOLLOWER, SET_LIST_FOLLOWING } from "./mutationTypes";
...
const actions = {
    ...
    [FETCH_LIST_FOLLOWER](context, username ) {
        return ApiService.get(`profile/follower/${username}`)
                        .then(({ data }) => {
    ...
    [FETCH_LIST_FOLLOWING](context, username) {
        return ApiService.get(`profile/following/${username}`)
                         .then(({ data }) => {
